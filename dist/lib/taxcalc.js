...
function updateProductPrices(product, rate, sourcePriceInclTax = false) {
...
function calculateProductTax(product, taxClasses, taxCountry = 'PL', taxRegion = '', sourcePriceInclTax = false) {
    let rateFound = false;
...
exports.calculateProductTax = calculateProductTax;
